...
Would you like me to help draft the *equations & assumptions* section for Anna, or perhaps set up the initial Python script structure to get a head start on solving the PDEs?